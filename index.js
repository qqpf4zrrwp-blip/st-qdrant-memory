...
async function indexCharacterChats() {
  ...
  // Attach to the top-level container so position:fixed resolves against the
  // viewport, not a transformed ancestor in some mobile ST layouts.
  ;(document.getElementById("movingDivs") ? $("#movingDivs") : $("body")).append(modalHtml)
