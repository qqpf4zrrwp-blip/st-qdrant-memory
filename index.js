  ...
  const modalHtml = `
    ...
    ">
      <div style="color: #333;">
        ...
        <button id="qdrant_index_cancel" class="menu_button" style="margin-top: 15px; min-height: 40px; padding: 8px 16px;">取消</button>
      </div>
    </div>
        ...
        ">
            <div style="color: #333; word-break: break-all; overflow-wrap: anywhere;">
                ...
                <div style="margin-top: 20px; display: flex; gap: 10px; flex-wrap: wrap;">
                    <button id="qdrant_delete_collection_btn" class="menu_button" style="background-color: #dc3545; color: white; flex: 1 1 140px; min-height: 40px; padding: 8px 16px;">
                        刪除所有記憶
                    </button>
                    <button id="qdrant_close_modal" class="menu_button" style="flex: 1 1 100px; min-height: 40px; padding: 8px 16px;">
                        關閉
                    </button>
                </div>
            </div>
